...
import 'package:e_commerse/common/widgets/texts/t_brand_title_with_verified_icon.dart';
      ...
      children: [
        ...
        Row(
          children: [
            ...
            const TBrandTitleWithVerification(title: 'Nike', brandTextSize: TextSizes.medium,),
          ],
        ),
      ],
    );
